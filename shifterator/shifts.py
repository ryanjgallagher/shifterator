...
class TsallisDivergenceShift(Shift):
    """
    Shift object for calculating the Tsallis Entropy divergence (JSD) between two
    systems
    ...
    def __init__(
        ...
        type2freq_2 = type2freq_2.copy()
        # Get shift scores
        type2p_1, type2p_2, type2m, type2s_1, type2s_2 = entropy.get_tsallis_jsd_scores(
            type2freq_1,
            type2freq_2,
            weight_1=weight_1,
            weight_2=weight_2,
